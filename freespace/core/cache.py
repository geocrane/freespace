...
обхода в глубину::
    ...
    {"v":2,"root":"/Users/me","created":1755123456,"total":812734,"files":1240}
    0	d	812734	1755123456	1240	/Users/me
    1	d	40213	1755123400	821	Dev
    2	f	1024	1755123000	0	README.md

Четвёртое поле — время последней активности (``scanner._activity``), у папок
уже свёрнутое по файлам внутри. Отдельно его пересчитывать после загрузки не
нужно: снимок хранит готовое значение.
...
SUFFIX = ".fsnap.gz"
# 2 — в поле времени лежит не st_mtime, а время последней активности
# (см. ``scanner._activity``), у папок свёрнутое по файлам внутри.
# Снимки версии 1 несут в том же поле другой смысл и отбрасываются.
FORMAT_VERSION = 2
